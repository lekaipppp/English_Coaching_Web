export const SITE_NAME = "Crosswire";

// Update to the real production domain before launch.
export const SITE_URL = "https://www.crosswire.coach";

export const SITE_TAGLINE = "Say it directly, so it lands.";
...
export const CONTACT_EMAIL = "hello@crosswire.coach";
